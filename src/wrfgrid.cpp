...
void WrfGrid::initGrid(Parameters& parameters)
{
  // create proj4 string 
...
WrfGrid::ProjString WrfGrid::makeProjString_(Parameters& parameters)
{
...
WrfGrid::GridCoordinates WrfGrid::wgsToGridCoordinates(Latitude const &, Longitude const &)
{
